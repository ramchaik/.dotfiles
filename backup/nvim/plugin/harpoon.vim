...
"hack: from alacritty: Ctrl+; -> M+\; now Ctrl+; can be used in vim
nnoremap <silent><M-Bslash> :lua require("harpoon.ui").nav_file(4)<CR> 
...
nnoremap <silent><leader>ts :lua require("harpoon.term").gotoTerminal(3)<CR>
...
nnoremap <silent><leader>cs :lua require("harpoon.term").sendCommand(3, 1)<CR>
