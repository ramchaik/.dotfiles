...
# If I have NTHING focused and I change spaces, try to focus on ANY visible window on the new space. Else, try to focus on any visibe window on any visible space.
# the end.
