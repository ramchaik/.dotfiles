...
# git config --global user.name "Vaibhav Singh"
# git config --global user.email 0vaibhavsingh0@gmail.com
...
cd ~
git clone --recursive git@github.com:Ramchaik/dotfiles.git dotfiles
cd ~/dotfiles
rake
